...
import static com.giancodes.dao.DBAppointments.getCustomerAppointments;
import static com.giancodes.dao.DBContacts.getAllContacts;
import static com.giancodes.dao.DBCustomer.getAllCustomers;
import static com.giancodes.dao.DBUsers.getAllUsers;
...
import com.giancodes.dao.DBUsers;
import com.giancodes.lambda.LookupCustomer;
 ...
 */
    ...
    private void CancelButtonAction(ActionEvent event) throws IOException, SQLException {
               ...
               Parent AddMenuParent = FXMLLoader.load(getClass().getResource("/View/AllAppointment.fxml"));
