...
import static com.giancodes.dao.DBCountries.getAllCountries;
import static com.giancodes.dao.DBFirstDivision.getUpdateStates;
...
import com.giancodes.dao.DBCountries;
import com.giancodes.dao.DBFirstDivision;
import com.giancodes.model.Countries;
import com.giancodes.model.Customer;
import com.giancodes.model.FirstDivision;
...
public class UpdateCustomerRecordController implements Initializable {
    ...
    private void UpdateButtonAction(ActionEvent event) throws SQLException, IOException {
        ...
        if(TextFieldName1.getText().isEmpty() || TextFieldName1.getText().isEmpty())
        ...
        if(ps.getUpdateCount() > 0)
            ...
            System.out.println("\n No change!");
               ...
               Parent AddMenuParent = FXMLLoader.load(getClass().getResource("/View/CustomerRecords.fxml"));
